...
export const AllDefaultParams = [
  { name: "Rcs", default: 830.0, range: (400.0, 1000.0), fitting: true },
  { name: "Rcp", default: 10.0, range: (5.0, 150.0), fitting: true },
  { name: "Ras", default: 20.0, range: (10.0, 450.0), fitting: true },
  { name: "Rvs", default: 25.0, range: (15.0, 60.0), fitting: true },
  { name: "Rap", default: 13.0, range: (6.0, 50.0), fitting: true },
  { name: "Rvp", default: 15.0, range: (5.0, 30.0), fitting: true },
  { name: "Cas", default: 1.83, range: (0.5, 4.0), fitting: true },
  { name: "Cvs", default: 70.0, range: (50.0, 250.0), fitting: true },
  { name: "Cap", default: 20.0, range: (2.0, 30.0), fitting: true },
  { name: "Cvp", default: 7.0, range: (5.0, 15.0), fitting: true },
  { name: "LV_Ees", default: 2.21, range: (1.0, 3.0), fitting: true },
  { name: "LV_alpha", default: 0.029, range: (0.02, 0.04), fitting: true },
  { name: "LV_beta", default: 0.34, range: (0.18, 0.4), fitting: true },
  { name: "LA_Ees", default: 0.48, range: (0.2, 0.7), fitting: true },
  { name: "LA_alpha", default: 0.058, range: (0.04, 0.07), fitting: true },
  { name: "LA_beta", default: 0.44, range: (0.3, 0.6), fitting: true },
  { name: "RV_Ees", default: 0.74, range: (0.5, 1.5), fitting: true },
  { name: "RV_alpha", default: 0.028, range: (0.01, 0.035), fitting: true },
  { name: "RV_beta", default: 0.34, range: (0.15, 0.5), fitting: true },
  { name: "RA_Ees", default: 0.38, range: (0.2, 0.6), fitting: true },
  { name: "RA_alpha", default: 0.046, range: (0.03, 0.07), fitting: true },
  { name: "RA_beta", default: 0.44, range: (0.3, 0.5), fitting: true },
  { name: "Qvs_initial", default: 749.9842973712131, range: (200.0, 6000.0), fitting: true },
  { name: "Ras_prox", default: 30.0, range: (10.0, 100.0), fitting: true },
  { name: "Rap_prox", default: 15.0, range: (5.0, 50.0), fitting: true },
  { name: "Rmv", default: 2.5, range: (2.5, 2.5), fitting: false },
  { name: "Rtv", default: 2.5, range: (2.5, 2.5), fitting: false },
  { name: "Cas_prox", default: 0.54, range: (0.54, 0.54), fitting: false },
  { name: "Cap_prox", default: 1.0, range: (1.0, 1.0), fitting: false },
  { name: "LV_V0", default: 5.0, range: (1.0, 50.0), fitting: true },
  { name: "LV_Tmax", default: 300.0, range: (300.0, 300.0), fitting: false },
  { name: "LV_tau", default: 25.0, range: (25.0, 25.0), fitting: false },
  { name: "LV_AV_delay", default: 160.0, range: (160.0, 160.0), fitting: false },
  { name: "LA_V0", default: 10.0, range: (5.0, 20.0), fitting: true },
  { name: "LA_Tmax", default: 125.0, range: (125.0, 125.0), fitting: false },
  { name: "LA_tau", default: 20.0, range: (20.0, 20.0), fitting: false },
  { name: "LA_AV_delay", default: 0.0, range: (0.0, 0.0), fitting: false },
  { name: "RV_V0", default: 5.0, range: (2.0, 30.0), fitting: true },
  { name: "RV_Tmax", default: 300.0, range: (300.0, 300.0), fitting: false },
  { name: "RV_tau", default: 25.0, range: (25.0, 25.0), fitting: false },
  { name: "RV_AV_delay", default: 160.0, range: (160.0, 160.0), fitting: false },
  { name: "RA_V0", default: 10.0, range: (3.0, 30.0), fitting: true },
  { name: "RA_Tmax", default: 125.0, range: (125.0, 125.0), fitting: false },
  { name: "RA_tau", default: 20.0, range: (20.0, 20.0), fitting: false },
  { name: "RA_AV_delay", default: 0.0, range: (0.0, 0.0), fitting: false },
  { name: "HR", default: 90.0, range: (90.0, 90.0), fitting: false },
  { name: "Ravs", default: 0.0, range: (0.0, 0.0), fitting: false },
  { name: "Ravr", default: 100000.0, range: (100000.0, 100000.0), fitting: false },
  { name: "Rmvr", default: 100000.0, range: (100000.0, 100000.0), fitting: false },
  { name: "Rmvs", default: 0.0, range: (0.0, 0.0), fitting: false },
  { name: "Rpvr", default: 100000.0, range: (100000.0, 100000.0), fitting: false },
  { name: "Rpvs", default: 0.0, range: (0.0, 0.0), fitting: false },
  { name: "Rtvr", default: 100000.0, range: (100000.0, 100000.0), fitting: false },
  { name: "Rtvs", default: 0.0, range: (0.0, 0.0), fitting: false },
  { name: "Rda", default: 3.0, range: (3.0, 3.0), fitting: false },
  { name: "Cda", default: 0.52, range: (0.52, 0.52), fitting: false }
];