export default {
  ...
  Cvs : "体静脈コンプライアンス", 
  Cvp : "肺静脈コンプライアンス", 
  Cas_prox : "大動脈近位部コンプライアンス", 
  Cap_prox : "肺動脈近位部コンプライアンス", 
  Volume: "有効循環血漿量",
  HR: "心拍数",
  Ravs: "大動脈弁狭窄",
  Ravr: "大動脈弁逆流",
  ...
  IABP:"IABP",
  IabpFreq:"アシスト比(IABP)",
  DelayInflation:"拡張タイミング(IABP)",
  DelayDeflation:"収縮タイミング(IABP)",
  Qdrive:"バルーン容量(IABP)",
  RadiusDscAorta : "留置部大動脈半径(IABP)",
  LengthIabp: "バルーン長(IABP)",
  Terms:"利用規約",
  Contact:"お問い合わせ",
